...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentOCRJob.is_finished'
        db.add_column('djocr_logic_documentocrjob', 'is_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DocumentOCRJob.is_finished'
        db.delete_column('djocr_logic_documentocrjob', 'is_finished')
