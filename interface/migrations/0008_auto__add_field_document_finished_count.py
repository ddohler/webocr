...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('interface_document', 'finished_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.finished_count'
        db.delete_column('interface_document', 'finished_count')
