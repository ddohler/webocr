...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentPage.stage_output_extension'
        db.add_column('interface_documentpage', 'stage_output_extension', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentPage.stage_output_extension'
        db.delete_column('interface_documentpage', 'stage_output_extension')
    ...
    models = {
        ...
        'interface.documentpage': {
            ...
            'stage_output_extension': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
